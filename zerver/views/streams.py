...
def update_subscriptions_backend(
    ...
    add: Sequence[Mapping[str, Any]] = REQ(json_validator=add_subscriptions_schema, default=[]),
) -> HttpResponse:
...
def add_subscriptions_backend(
    request: HttpRequest,
    user_profile: UserProfile,
    streams_raw: Sequence[Mapping[str, Any]] = REQ(
    ...
    for stream_dict in streams_raw:
        ...
        stream_dict_copy["is_board"] = stream_dict.get("is_board", False)
